...
python main.py \
    ...
    --depth-encoder-backbone-block nonbottleneck1d \
    --no-pretrained-backbone \
    --weights-filepath ./trained_models/r34_NBt1D_pre.pth \
    --checkpointing-metrics valid_semantic_miou \
...
python main.py \
    ...
    --input-modalities rgb depth \
    --tasks semantic scene instance orientation\
    --tasks-weighting 1.0 0.25 3.0 1\
...
python main.py \
    ...
    --depth-encoder-backbone-block nonbottleneck1d \
    --encoder-backbone-pretrained-weights-filepath ./trained_models/imagenet/r34_NBt1D.pth \
    --weights-filepath /root/xxh/173/EMSANet/trained_models/r34_NBt1D_pre.pth \
    ...
    --skip-sanity-check \
    --validation-only \
    --visualization-output-path ./visual \
    --visualize-validation
...
python main.py \
    --results-basepath ./results \
    --dataset sunrgbd \
    --dataset-path /root/xxh/173/EMSANet/datasets/SUNRGB-D \
    --input-modalities rgb depth \
    --tasks semantic \
    --tasks-weighting 1.0 \
    --rgb-encoder-backbone resnet34 \
