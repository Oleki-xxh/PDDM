...
from nicr_mt_scene_analysis.data.preprocessing import NormalizeDepth_mari
from nicr_mt_scene_analysis.data.preprocessing import NormalizeDepth_meta
from nicr_mt_scene_analysis.data.preprocessing import NormalizeDepth_anything
...
def get_preprocessor_pddm(
    ...
    if 'depth' in dataset.sample_keys:
        transforms.append(
            NormalizeDepth(
    ...
    if 'depth_anything' in dataset.sample_keys:
        transforms.append( 
            NormalizeDepth_anything(
                depth_mean=dataset_config.depth_stats.mean,
                depth_std=dataset_config.depth_stats.std,
                raw_depth=False
            )
    ...
    if 'depth_meta' in dataset.sample_keys:
        transforms.append( 
            NormalizeDepth_meta(
                depth_mean=dataset_config.depth_stats.mean,
                depth_std=dataset_config.depth_stats.std,
    ...
    if 'depth_mari' in dataset.sample_keys:
        transforms.append( 
            NormalizeDepth_mari(
                depth_mean=dataset_config.depth_stats.mean,
                depth_std=dataset_config.depth_stats.std,
